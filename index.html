...
<body>
   ...
   <div class="profile" >
    ...
    <p class="animate__animated animate__fadeInDownBig">My sosmed</p>
   </div>
   ...
   <!-- link tree button-->
    <div class="link">
        ...
        <a href="https://youtube.com/ibnuharunalmudzakir7633" target="_blank" class="animate__animated animate__bounceInLeft animate__delay-4s">youtube</a>
    </div>
